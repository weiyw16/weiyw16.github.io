...
nt_o=2048
dt=0.002
#datapath=/data/wyw/DATA/VSPdata/nus_whole_vx/curl
...
#datapath=/data/wyw/DATA/VSPdata/nus_pow_tbt_model7_shot140/curl
#datapath=/data/wyw/DATA/VSPdata/fortest_model_${nunum}/curl
datapath=/home/wyw/2021_workspace/B-rename_for_input/test_model_${nunum}/curl
...
#maxname=${maxminpath}/model_7_shot_${this_shot}_curl_max.txt
#minname=${maxminpath}/model_7_shot_${this_shot}_curl_max.txt
...
echo "n1=${nt_o} n2=${nr} data_format=native_float in=${datapath}/curl_${this_shot}.bin" > ${this_shot}_ori.rsf
