...
#datapath=/data/wyw/DATA/VSPdata/fortest_model_${nunum}/vx
datapath=/home/wyw/2021_workspace/B-rename_for_input/test_model_${nunum}/vx
...
echo "n1=${nt_o} n2=${nr} data_format=native_float in=${datapath}/vx_${this_shot}.bin" > ${this_shot}_ori.rsf
...
#
sfspray < model_${mnum}_shot_${this_index}_vx_max.rsf n=3001 |\
  sftransp plane=12 |\
